...
function 生成界面()
	...
	p:addRadioBoxGroup(8,4,'选择任务','0','探索','御魂','觉醒','突破','御灵','妖气','狗粮升星','抽厕纸','修罗战场','决战鬼王座')	
	p:newLine()
	...
	p:newLine()
	p:addRadioBoxGroup(5,1,'御魂选择BOSS','0','八歧大蛇','业原火')
	p:newLine()
	local b=p:newBox(0.5,5)
	b:addImage(3,1,'icons/titleicon.jpg')
	...
	p:addComboBox(1.6,1,'御魂组队方式','1','单人','3人队长','2人队长','队员')
	p:newLine()
	...
	p:newLine()
	p:addLebel(9.5,1,'（换狗粮功能为御魂和业原火任务共享。）',25,nil,'255,0,0')
	p:newLine()
	...
	p:newLine()
	p:addLebel(1.5,1,'组队方式',30,nil,'0,0,255')
	p:addComboBox(1.6,1,'觉醒组队方式','1','单人','3人队长','2人队长','队员')
	p:newLine()
	p:addLebel(1.5,1,'集火设置',30,nil,'0,0,255')
